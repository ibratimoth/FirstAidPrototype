...
const CategoryPage = () => {
  ...
  const fetchCategories = async () => {
    try {
      const response = await axios.get(
        "http://192.168.211.185:8082/api/v1/category/get-category"
      );
  ...
  const handleCreateCategory = async () => {
    try {
      const response = await axios.post(
        "http://192.168.211.185:8082/api/v1/category/create-category",
  ...
  const handleUpdateCategory = async (id) => {
    try {
      const response = await axios.put(
        `http://192.168.211.185:8082/api/v1/category/update-category/${id}`,
  ...
  const handleDeleteCategory = async () => {
    try {
      await axios.delete(
        `http://192.168.211.185:8082/api/v1/category/delete-category/${deleteId}`
      );
